...
<meta name="description" content="<spring:escapeBody htmlEscape="true">${course.tags}</spring:escapeBody>"> 
<meta name="keywords" content="<spring:escapeBody htmlEscape="true">${course.tags}</spring:escapeBody>"> <%-- COURSE's meta to use with GSA --%>
<meta name="cTitle" content="<spring:escapeBody htmlEscape="true">${course.title}</spring:escapeBody>" >
<meta name="cTopics" content="<spring:escapeBody htmlEscape="true">${course.tags}</spring:escapeBody>" >
