...
<meta name="cStart" content="<fmt:formatDate value="${course.start}" type="date" pattern="dd-M-yyyy" />" >
<meta name="cEnd" content="<fmt:formatDate value="${course.end}" type="date" pattern="dd-M-yyyy" />" >
