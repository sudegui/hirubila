...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='img/interfaz/plus.gif' class='statusicon' />", "<img src='img/interfaz/minus.gif' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
